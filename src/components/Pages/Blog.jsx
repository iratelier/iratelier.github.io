        ...
        return (
            <section id="container" className="blog">
                <div className="container-wrap">
                    <h2 className="txt-headline">Blog</h2>
                    <div className="contents-wrap">
                        <a class="porlink" href="portfolio/kakaopage2.html" rel="#kakaopage2" onClick={this.handleClick}>
                            열기
                        </a>
                        ...
                        <div className="aaa">
                            ...
                            {this.state.showPopup ? <LayerFrame text="Close Me" closePopup={this.togglePopup.bind(this)} /> : null}
                        </div>
                    </div>
